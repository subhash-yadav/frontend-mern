...
import {fetchAllBrandAsync,fetchAllCategoriesAsync,fetchProductsByFiltersAsync} from "../productSlice";
...
const ProductList = () => {
  ...
  const { products, totalItems, categories, brands } = useSelector((state) => state.products);
  const filters = [
    {
      id: "category",
      name: "Category",
